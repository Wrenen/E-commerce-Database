...
/*Shopping cart*/
INSERT INTO customer_shopping_cart (`cart_id`,`customer_id`,`product_id`,`quantity`,`price_per_unit`,`total_cost`) VALUES (1,6,'21000',2,400.99,801.98);
INSERT INTO customer_shopping_cart (`cart_id`,`customer_id`,`product_id`,`quantity`,`price_per_unit`,`total_cost`) VALUES (2,7,'32000',3,45.99,91.98);
...
/*Distributor*/
INSERT INTO `` (`distributor_id`,`distributor_name`,`products`,`country_origin`) VALUES (10000,'Delly','Pot Set, Knife Set','Nigeria ');
INSERT INTO `` (`distributor_id`,`distributor_name`,`products`,`country_origin`) VALUES (10001,'Lonobo','A3 Battery, Measuring Tape','Turkey');
INSERT INTO `` (`distributor_id`,`distributor_name`,`products`,`country_origin`) VALUES (10101,'Sicket','Volt Meter, Power Supply','India');
INSERT INTO `` (`distributor_id`,`distributor_name`,`products`,`country_origin`) VALUES (10110,'Baggery','Alexa, Whey Protein, Kito Gummies','Pakistan');
INSERT INTO `` (`distributor_id`,`distributor_name`,`products`,`country_origin`) VALUES (10111,'Cluckerster','Ipad, Xbox, Air Fryer','Afganistan');
...
/*Employee*/
INSERT INTO employee (`employee_id`,`department_id`,`name`,`address`,`phone_number`,`department`,`email`) VALUES (1,1,'Muhammad Zafar','123 Fortnite Ave','6478349863','IT','zafa3750@mylaurier.ca');
INSERT INTO employee (`employee_id`,`department_id`,`name`,`address`,`phone_number`,`department`,`email`) VALUES (2,1,'Basar Ozdemir','25 LootLake St','6748547543','IT','ozde0720@mylaurier.ca');
INSERT INTO employee (`employee_id`,`department_id`,`name`,`address`,`phone_number`,`department`,`email`) VALUES (3,1,'Abesson Enjugu','26 University Ave','6473930456','IT','enju8000@mylaurier.ca');
INSERT INTO employee (`employee_id`,`department_id`,`name`,`address`,`phone_number`,`department`,`email`) VALUES (4,1,'Wrenen D\'Cunha','68 Brampton Dr','6473452564','IT','dcun0590@mylaurier.ca');
INSERT INTO employee (`employee_id`,`department_id`,`name`,`address`,`phone_number`,`department`,`email`) VALUES (5,2,'Natalie Davis','47 Gom St','6478294934','customer_service','ndavis@database.com');
INSERT INTO employee (`employee_id`,`department_id`,`name`,`address`,`phone_number`,`department`,`email`) VALUES (6,2,'Guy Jocky','76 High St','6573848384','customer_service','guy@gmail.com');
INSERT INTO employee (`employee_id`,`department_id`,`name`,`address`,`phone_number`,`department`,`email`) VALUES (7,2,'Girish Dipak','97 Ronda Ct','6573848488','customer_service','girpak@mail.com');
INSERT INTO employee (`employee_id`,`department_id`,`name`,`address`,`phone_number`,`department`,`email`) VALUES (8,2,'Etele Perma','666 Natas Rd','6584994020','customer_service','etele.p@mail.com');
INSERT INTO employee (`employee_id`,`department_id`,`name`,`address`,`phone_number`,`department`,`email`) VALUES (9,3,'Jacob Smith','734 Night Ave','5884848488','marketing','jacsmirht@mail.com');

/*Orders*/
INSERT INTO orders (`order_id`,`customer_id`,`products`,`quantity`,`Price per unit`,`total cost`,`date`) VALUES (1,1,'35000',2,5.99,11.98,'2022-12-15 00:00:00');
INSERT INTO orders (`order_id`,`customer_id`,`products`,`quantity`,`Price per unit`,`total cost`,`date`) VALUES (2,5,'42000',3,40.99,122.97,'2023-01-29 00:00:00');
INSERT INTO orders (`order_id`,`customer_id`,`products`,`quantity`,`Price per unit`,`total cost`,`date`) VALUES (3,9,'44000',4,10.99,43.96,'2023-02-14 00:00:00');
...
/*Shipping Info */
INSERT INTO shipping_info (`shipping_id`,`order_id`,`customer_id`,`shipping_address`,`shipping_cost`,`shipping_method`) VALUES (1,1,3,'78 Tomato Town, Waterloo',15.99,'Normal');
INSERT INTO shipping_info (`shipping_id`,`order_id`,`customer_id`,`shipping_address`,`shipping_cost`,`shipping_method`) VALUES (2,2,2,'23 Summoners Rift, Mississuaga',15.99,'Normal');
INSERT INTO shipping_info (`shipping_id`,`order_id`,`customer_id`,`shipping_address`,`shipping_cost`,`shipping_method`) VALUES (3,3,1,'39 Salty Springs, Michigan',10.99,'Express');

/*Tracking Info*/
INSERT INTO tracking_info (`shipping_id`,`order_id`,`customer_id`,`status`,`tracking_id`) VALUES (1,1,3,'on_route',1);
INSERT INTO tracking_info (`shipping_id`,`order_id`,`customer_id`,`status`,`tracking_id`) VALUES (2,2,4,'on_route',2);
INSERT INTO tracking_info (`shipping_id`,`order_id`,`customer_id`,`status`,`tracking_id`) VALUES (3,3,6,'shipping',3);

/*Wish List*/
INSERT INTO wish_list (`wish_list_id`,`customer_id`,`products`,`quantity`,`Price per unit`,`total cost`) VALUES (1,3,'3100',3,18.99,56.97);
INSERT INTO wish_list (`wish_list_id`,`customer_id`,`products`,`quantity`,`Price per unit`,`total cost`) VALUES (2,1,'2100',1,400.99,400.99);
INSERT INTO wish_list (`wish_list_id`,`customer_id`,`products`,`quantity`,`Price per unit`,`total cost`) VALUES (3,2,'2200',2,90.99,181.98);
